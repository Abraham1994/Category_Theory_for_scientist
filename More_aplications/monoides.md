...
Sean \\(L = (n,f) \\) y \\(L' = (n',f') \\) dos listas, se define la **concatenación de \\(L\\) y \\(L' \\)**, denotada por \\( L++L'\\), como la lista \\( (n+n',f++f'), donde \\( f++f':\overline{n+n'} \rightarrow \\) está dada por \\[f(x)= \left\lbrace \begin{array}{rcl}
